...
```{r sqlite_disconnect, results = 'hide'}
...
```{r mysql_tables, results = 'hide', eval = TRUE}
# Create tables if they do not exist
...
```{r max_mysql, results = 'hide', eval = TRUE}
...
```{r table_rows_mysql, comment = '', eval = TRUE}
...
```{r listings_load, results = 'hide', eval = TRUE}
loop <- 0
batch_size <- 100000
